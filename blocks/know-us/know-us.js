                ...
                <article class="container">
                    <div class="row text-center text-md-start mb-5">
                        <div class="col-12 mb-4 mb-md-0 wow fadeInLeft animatedBlock" data-wow-delay="0.2s" style="transition-delay: 0.2s; animation-delay: 0.2s;">
                            <span class="text-primary-600 d-block text-uppercase mb-3">KNOW US</span>
                            <h2 class="h5-head fw-500 mb-30">About Indo-German</h2>
                        </div>
                        ...
                        <div class="col-md-6 col-12 mb-4 mb-md-0 wow fadeInLeft animatedBlock" data-wow-delay="0.2s" style="transition-delay: 0.2s; animation-delay: 0.2s;">
                            <p class="sec2-para sec2-para-1 pe-0 pe-md-3">Infosys Engineering Services offers comprehensive product engineering and digital transformation solutions across industries. Our expertise spans mechanical, electrical, and embedded systems, software platforms, IoT, smart spaces, and network engineering. We support the full product lifecycle—from design and development to manufacturing and maintenance—leveraging emerging technologies like AI/ML, AR/VR, and autonomous robotics. With over 20,000 engineers and 40+ global centers, Infosys Engineering Services drives innovation in sectors such as automotive, aerospace, telecom, healthcare, and energy, helping clients enhance operational efficiency, sustainability, and customer experience.</p>
                        </div>
